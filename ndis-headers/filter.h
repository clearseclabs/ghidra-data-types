...
#define FILTER_FRIENDLY_NAME        L"ndis-headers NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{b4621ab7-7e7e-474b-b9ef-27c1c6b87084}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"ndis-headers"
...
DRIVER_DISPATCH ndisheadersDispatch;

DRIVER_DISPATCH ndisheadersDeviceIoControl;
